...
function ($scope, $stateParams) {
    ...
    function Start00015(SearchKey) {
        ...
        //         resp1 = "，一，"+resp.Attraction1+"，二，"+resp.Attraction2+"，三，"+resp.Attraction3+"，四，"+resp.Attraction4+"，五，"+resp.Attraction5;
        //         console.log(resp);
        //     }
        // });
        // return "依照"+localStorage.getItem("username")+"的偏好，推薦您以下景點"+resp1;
        
        var db = firebase.database();
        db.ref("景點資料/-KwUvLN_TPqb2pHxTfir/").on("value", function(snap) {
        var data = snap.val();
        console.log(data);
        }, function(err) {
            console.log('取得資料失敗');
